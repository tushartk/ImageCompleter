...
class CompletionNetwork(nn.Module):
    def __init__(self):
        ...
        # input_shape: (None, 2, img_h, img_w)
...
class LocalDiscriminator(nn.Module):
    def __init__(self, input_shape):
        ...
        # input_shape: (None, 64, img_h//4, img_w//4)
        # in_features = 64 * (self.img_h//4) * (self.img_w//4)
        in_features = 1152
...
class GlobalDiscriminator(nn.Module):
    def __init__(self, input_shape):
        ...
        # input_shape: (None, 64, img_h//4, img_w//4)
        self.conv6 = nn.Conv2d(128, 128, kernel_size=5, stride=2, padding=2)
