...
parser.add_argument('--steps_1', type=int, default=10000) #90000
parser.add_argument('--steps_2', type=int, default=5000) #10000
parser.add_argument('--steps_3', type=int, default=20000) #400000
parser.add_argument('--snaperiod_1', type=int, default=1000)
parser.add_argument('--snaperiod_2', type=int, default=2000)
parser.add_argument('--snaperiod_3', type=int, default=1000)
parser.add_argument('--cn_input_size', type=int, default=28)
parser.add_argument('--ld_input_size', type=int, default=10)
...
parser.add_argument('--alpha', type=float, default=4e-5)
parser.add_argument('--arc', type=str, choices=['celeba', 'places2'], default='places2')
